...
""" Esta version busca el clique más grande, pero en vez de arrancar por 20,
    arranca forzadamente por 18 hacia 20 y luego de 17 para abajo.
    Probe distintas configuraciones y esa parecía ser la mejor que no era 
    de 20 para abajo.
"""
